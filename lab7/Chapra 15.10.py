...
ax.set(xlabel = "Time in Days", ylabel="Concentration in Organisms/$cm^3$", title="Models of Growth Rates of Seaweed on Plate")
ax.grid(True)
ax.legend(loc="best")
fig.tight_layout()
fig.savefig("Time vs. Concentration Alpha.jpg")
fig.savefig("Time vs. Concentration Alpha.eps")
